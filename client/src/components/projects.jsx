...
class Projects extends Component {
  render() {
    return (
      ...
      //   <VizSensor
      //     onChange={isVisible => this.props.segmentChange('projects', isVisible)}
      //   >
      //     <React.Fragment>
      ...
      //                 </div>
      //                 <div className="content">
      //                   <a className="header">RGB Color Guessing Game</a>
      //                   <div className="meta">
      //                     <span>Description</span>
      //                   </div>
      //                   <div className="description">
      //                     <p>
      //                       Designed a game using vanilla javascript. This game is
      //                       fully responsive and allows users to guess a color by
      //                       a rgb color code given
      //                     </p>
      //                   </div>
      //                   <a className="extra">
